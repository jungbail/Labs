...
> DFS is best suited for tasks like finding strongly connected components, transversing graphs, and when you need to explore a path deeply, and figuring out if all the nodes are connected. 
* Can you come up with everyday examples of inorder, postorder, and preorder? (hint, look at your calculator)
> **Inorder Example: `3 + 4`**: 
> In inorder traversal, the operator appears between the numbers. This is how math expressions are written in the every day lifestyle. (3+4), for example, places the addition (+) operator between the numbers. 
> 
> **Preorder Example: `* + 5 2 8`**: In preorder transversal, the operator appears before the numbers, so in this example the multiplication and addition appears before the 5, 2, 8. 
> 
> **Postorder Example: `5 2 + 8 *`** In postorder traversal, the operator comes after the numbers. For this example, first you enter the 5, then you enter the 2, then you apply the addition symbol, and then you enter the eight, and then the operator of the multiplication symbol comes after- therefore demonstrating postorder transversal. 
...
[1] [BFS vs DFS Binary Tree]: https://www.geeksforgeeks.org/bfs-vs-dfs-binary-tree/

[2] [Difference Between BFS and DFS]: https://www.geeksforgeeks.org/difference-between-bfs-and-dfs/ 

[3] [DFS Traversal of a Tree Using Recursion]: https://www.geeksforgeeks.org/dfs-traversal-of-a-tree-using-recursion/

[4] [Tree Traversal BFS and DFS]: https://www.codingeek.com/data-structure/tree-traversal-bfs-and-dfs-introduction-explanation-and-implementation/
